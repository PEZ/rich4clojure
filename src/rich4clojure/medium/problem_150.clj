...
(tests
 ...
 (take 6 (__ 1234550000)) := [1234554321 1234664321 1234774321 1234884321 1234994321 1235005321]
 (first (__ (* 111111111 111111111))) := (* 111111111 111111111)
 (set (take 199 (__ 0))) := (set (map (fn* [p1__16226#] (first (__ p1__16226#))) (range 0 10000)))
