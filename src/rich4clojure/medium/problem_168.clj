...
(tests
 (take 5 (map (fn* [p1__16913#] (take 6 p1__16913#)) (__ str))) := [["00" "01" "02" "03" "04" "05"] ["10" "11" "12" "13" "14" "15"] ["20" "21" "22" "23" "24" "25"] ["30" "31" "32" "33" "34" "35"] ["40" "41" "42" "43" "44" "45"]]
 (take 6 (map (fn* [p1__16914#] (take 5 p1__16914#)) (__ str 3 2))) := [["32" "33" "34" "35" "36"] ["42" "43" "44" "45" "46"] ["52" "53" "54" "55" "56"] ["62" "63" "64" "65" "66"] ["72" "73" "74" "75" "76"] ["82" "83" "84" "85" "86"]]
 (__ * 3 5 5 7) := [[15 18 21 24 27 30 33] [20 24 28 32 36 40 44] [25 30 35 40 45 50 55] [30 36 42 48 54 60 66] [35 42 49 56 63 70 77]]
 (__ (fn* [p1__16915# p2__16916#] (/ p1__16915# (inc p2__16916#))) 1 0 6 4) := [[1 1/2 1/3 1/4] [2 1 2/3 1/2] [3 3/2 1 3/4] [4 2 4/3 1] [5 5/2 5/3 5/4] [6 3 2 3/2]]
 ...
 (let [m 377 n 610 w 987 check (fn [f s] (every? true? (map-indexed f s))) row (take w (nth (__ vector) m)) column (take w (map first (__ vector m n))) diagonal (map-indexed (fn* [p1__16918# p2__16917#] (nth p2__16917# p1__16918#)) (__ vector m n w w))] (and (check (fn* [p1__16920# p2__16919#] (= p2__16919# [m p1__16920#])) row) (check (fn* [p1__16922# p2__16921#] (= p2__16921# [(+ m p1__16922#) n])) column) (check (fn* [p1__16924# p2__16923#] (= p2__16923# [(+ m p1__16924#) (+ n p1__16924#)])) diagonal))) := true)
