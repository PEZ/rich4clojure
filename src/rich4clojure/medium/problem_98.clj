(ns rich4clojure.medium.problem-98
...
(tests
 (__ (fn* [p1__16892#] (* p1__16892# p1__16892#)) #{0 1 -2 -1 2}) := #{#{1 -1} #{-2 2} #{0}}
 (__ (fn* [p1__16893#] (rem p1__16893# 3)) #{0 1 4 3 2 5}) := #{#{0 3} #{1 4} #{2 5}}
 (__ identity #{0 1 4 3 2}) := #{#{3} #{2} #{1} #{0} #{4}}
 (__ (constantly true) #{0 1 4 3 2}) := #{#{0 1 4 3 2}})
